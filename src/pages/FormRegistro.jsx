...
const FormRegistro = () => {
    const { handleSubmitRegister, setEmail, setPassword, email, password } = useContext(AuthContext);
    ...
    const handleClick = async (e) => {
        e.preventDefault();
            try {
                await handleSubmitRegister(); // funcion context handleSubmitRegister
                alert('Usuario registrado');
                navigate('/pizzaMamaMiaHito08-react/login'); // Redirige al login si es necesario
            } catch (err) {
                ...
                <Row className="justify-content-center align-items-center">
                    ...
                    <Col md={5}>
                        ...
                        <Form onSubmit={validaFormulario}>
                            ...
                            <Button variant="outline-warning" type="submit" onClick={handleClick}>Registrarse</Button>
                        </Form>
                        </Col>
                </Row>
                <MensajeModal
