...
const FormLogin = () => {
    const { handleSubmitLogin, setEmail, setPassword, email, password } = useContext(AuthContext);
    ...
    const handleClick = async (e) => {
        e.preventDefault(); // Evitar la recarga de la página
            await handleSubmitLogin(); // funcion context handleSubmitLogin
                ...
                <Row className="justify-content-center align-items-center">
                    ...
                    <Col md={5}>
                        ...
                        <Form onSubmit={validaFormulario}>
                            ...
                            <Button variant="outline-warning" type="submit" onClick={handleClick}>Login</Button>
                        </Form>
                        </Col>
                </Row>
                <MensajeModal
